...
function check() {
  ...
  if (answer == word) {
    ...
    document.getElementById("Label_answer").innerHTML = "Correct Answer";
    document.getElementById("Label_answer").style.color = "green";
  } else {
    document.getElementById("Label_answer").innerHTML = "Wrong Answer";
    document.getElementById("Label_answer").style.color = "red";
  }
